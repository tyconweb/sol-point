...
class SalaryPaymentController extends Controller {
	...
	*/
	public function create($user_id, $salary_month) {
		...
		->get()
		->toArray();
		// print_r($deductions); exit;
		if (!empty($salary_payment)) {
			$salary_payment_details = SalaryPaymentDetails::where('salary_payment_id', $salary_payment->id)->get();
			return view('administrator.hrm.salary_payment.salary_payment_details', compact('user_id', 'salary_month','deductions', 'user', 'employee_salaries', 'salary_payment_details', 'salary_payment'));
		}
		return view('administrator.hrm.salary_payment.make_salary', compact('salary', 'bonuses', 'deductions','allowances', 'loans', 'user_id', 'salary_month', 'user'));
	}
	public function pdf($user_id, $salary_month) {
		...
		if (!empty($salary_payment)) {
			$salary_payment_details = SalaryPaymentDetails::where('salary_payment_id', $salary_payment->id)->get();
			$pdf = PDF::loadView('administrator.hrm.salary_payment.pdf', compact('salary','user_id', 'salary_month', 'user', 'employee_salaries', 'salary_payment_details', 'salary_payment'));
...
/**
	...
	*/
	public function list($salary_month) {
		...
		$employees	= $employees->get(['payrolls.*', 'designations.designation', 'users.name', 'users.id as user_id'])
					  ->toArray();
