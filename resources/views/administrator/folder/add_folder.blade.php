        ...
        <div class="box box-default">
            ...
            <form action="{{ url('/folders/store') }}" method="post" name="folder_name_add_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('folder_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="folder_description" id="folder_description" placeholder="{{ __('Enter folder description..') }}">{{ old('folder_description') }}</textarea>
                                @if ($errors->has('folder_name'))
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> {{ __('Add folder') }}</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
