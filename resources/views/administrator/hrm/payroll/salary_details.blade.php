    ...
    <div class="row">
              ...
              <table class="table borderless">
                ...
                <tr>
                  ...
                  <td>
                   ...
                   {{ __('Internship (three to six months)') }} 
                    @else
                    {{ __('Not Confirmed') }}
                    @endif
                  </td>
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <table class="table table-bordered">
              ...
              <tr>
                <td>09.</td>
                <td>{{ __('NHIF Deduction') }}</td>
                <td>-{{ $salary['nhif']}}</td>
                <td></td>
              </tr>
              <tr>
                <td>10.</td>
                <td>{{ __('NSSF Deduction') }}</td>
                <td>-{{ $salary['nssf']}}</td>
                <td></td>
              </tr>
               <tr>
      ...
      <div class="col-md-12">
        <div class="box box-danger">
          ...
          @php($total_deduction = $salary['tax_deduction'] + $salary['nhif']  + $salary['nssf'] + $salary['other_deduction']+ $salary['provident_fund_deduction'])
