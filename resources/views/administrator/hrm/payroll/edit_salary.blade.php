          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <div class="form-group{{ $errors->has('nhif') ? ' has-error' : '' }}">
                ...
                <input type="number" name="nhif" readonly="" value="{{ $salary['nhif'] }}" class="form-control" id="nhif" placeholder="{{ __('Enter NHIF deduction..') }}">
                @if ($errors->has('nhif'))
                <span class="help-block">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <div class="form-group{{ $errors->has('total_allowance') ? ' has-error' : '' }}">
                ...
                <input type="number" disabled class="form-control" id="total_allowance">
              </div>
