...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a>{{ __('Salary') }}</a></li>
      <li class="active">{{ __('Salary Report') }}</li>
    </ol>
  </section>
      ...
      <div class="card card-primary card-outline">
        <div class="card-header Su clearfix">
          <div class="Left_One float-left w-50">
            <h3 class="card-title FormTitle">{{__('Salary Report')}}</h3>
          </div>
        ...
        <div class="card-body Border_bg">
          <div class="state_hader clearfix">
            ...
            <div class="state_title float-left w-50">
              <h3 class="mb-0">{{__('Salary Report Of')}} {{date("F Y", strtotime($salary_month))}}</h3>
          ...
          <div class="salary_table">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td><span class="TR_B">KES{{number_format($grosstotal, 2, '.', ',')}}</span></td>
                <td><span class="TR_B">KES{{number_format($didcttotal, 2, '.', ',')}}</span></td>
                <td><span class="TR_B">KES{{number_format($nettotal, 2, '.', ',')}}</span></td>
                <td><span class="TR_C">KES{{number_format($pftotal, 2, '.', ',')}} </span></td>
                <td><span class="TR_C">KES{{number_format($paymenttotal, 2, '.', ',')}} </span></td>
              </tr>
            </tbody>
          </table>
