      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-orange">
            <div class="inner">
              <h3><i class="fa fa-envelope"></i> {{ count($leaves) }}</h3>
              <center><b>{{ __('Leaves Applications') }}</b></center>
            </div>
            <div class="icon">
              
            </div>
            <a href="{{ url('/hrm/application_lists') }}" class="small-box-footer">{{ __('More info ') }}<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              <h3><i class="fa fa-file"></i> {{ count($notices) }}</h3>
              <center><b>{{ __('Notices') }}</b></center>
            </div>
            <div class="icon">
              
            </div>
            <a href="{{ url('/hrm/notice') }}" class="small-box-footer">{{ __('More info ') }}<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><i class="fa fa-building-o"></i> {{ count($job_groups) }}</h3>
              <center> <b>{{ __('Job Groups') }}</b></center>
            </div>
            <div class="icon">
