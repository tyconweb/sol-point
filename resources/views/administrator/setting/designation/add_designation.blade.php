                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- /.form-group -->
                            <label for="department_id">{{ __('Job Group') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('designation_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="designation_description" id="designation_description" placeholder="{{ __('Enter designation description..') }}">{{ old('designation_description') }}</textarea>
                                @if ($errors->has('designation'))
                                <span class="help-block">
