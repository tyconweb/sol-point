                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('leave_category') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="leave_category" id="leave_category" class="form-control" value="{{ old('leave_category') }}" placeholder="{{ __('Enter category name..') }}">
                            ...
                            <!-- /.form-group -->
                            <label for="leave_days">{{ __('Number of leaves ') }}<span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('leave_days') ? ' has-error' : '' }} has-feedback">
                                <input type="number" name="leave_days" id="leave_days" class="form-control" value="{{ old('leave_days') }}" placeholder="{{ __('Enter number of leaves..') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('leave_category_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="leave_category_description" id="leave_category_description" placeholder="{{ __('Enter leave category description..') }}">{{ old('leave_category_description') }}</textarea>
                                @if ($errors->has('leave_category'))
                                <span class="help-block">
