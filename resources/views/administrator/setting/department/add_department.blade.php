...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/setting/departments') }}">{{ __('Job Groups') }}</a></li>
            <li class="active">{{ __('Add Job Group') }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">{{ __('Add Job Group') }}</h3>
            ...
            <form action="{{ url('setting/departments/store') }}" method="post" name="department_add_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="department">{{ __('Job Group') }} <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="department" id="department" class="form-control" value="{{ old('department') }}" placeholder="{{ __('Enter Job group name..') }}">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="department_description">{{ __('Job Group Description') }} <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('department_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="department_description" id="department_description" placeholder="{{ __('Enter Job group description..') }}">{{ old('department_description') }}</textarea>
                                @if ($errors->has('department'))
                                <span class="help-block">
