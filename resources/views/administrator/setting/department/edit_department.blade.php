    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">{{ __('Edit Job Group') }}</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="department" id="department" class="form-control" value="{{ $department['department'] }}" placeholder="{{ __('Enter job group name..') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('department_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="department_description" id="department_description" placeholder="{{ __('Enter job group description..') }}">{{ $department['department_description'] }}</textarea>
                                @if ($errors->has('department'))
                                <span class="help-block">
