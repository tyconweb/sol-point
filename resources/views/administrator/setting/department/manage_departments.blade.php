...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ __('Job Groups') }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">{{ __('Manage job groups') }}</h3>
            ...
            <div class="box-body">
                ...
                <div  class="col-md-6">
                    <a href="{{ url('/setting/departments/create') }}" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> {{ __('Add Job Group') }}</a>
                </div>
                <div  class="col-md-6">
                    ...
                    <table  class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>{{ __('SL#') }}</th>
                                <th>{{ __('Job Group') }}</th>
                                <th>{{ __('Job Group Description') }}</th>
