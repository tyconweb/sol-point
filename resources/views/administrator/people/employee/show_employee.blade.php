            ...
            <div id="printable_area">
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                        ...
                        <tr>
                             <td>{{ __('Next Kin Name') }}</td>
                            <td>
                                {{ $employee->kin_details_name }}
                            </td>
                        </tr>
                        <tr>
                             <td>{{ __('Next of Kin Relationship') }}</td>
                            <td>
                                {{ $employee->kin_details_relation }}
                            </td>
                        </tr>
                        <tr>
                             <td>{{ __('Next of Kin Phone Number') }}</td>
                            <td>
                                {{ $employee->kin_details_phone }}
                            </td>
                        </tr>
                        <tr>
